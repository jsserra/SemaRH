...
import com.pmm.semarh.dao.SexoDao;
...
public class SexoWs {
    ...
    @GET
    @Path("getListaSexo")
    public List<Sexo> getListaSexo(@Context HttpHeaders headers, @Context HttpServletRequest request) {
