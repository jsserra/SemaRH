...
import com.pmm.semarh.ws.model.ModelCpfGespesWs;
...
public class CpfGespesWs {

    @EJB
    CpfGespesDao daoGespesCpf;

    @GET
    @Path("getListaCpfGespes")
    public List<CpfGespes> getListaCpfGespes(@Context HttpHeaders headers, @Context HttpServletRequest request) {
        ...
        try {
            ...
            return daoGespesCpf.getListaCpfGespes();
    ...
    @GET
    @Path("getListaCpfGespesWs")
    public List<ModelCpfGespesWs> getListaCpfGespesPessoal(@Context HttpHeaders headers, @Context HttpServletRequest request) {
        try {
            List<CpfGespes> list = daoGespesCpf.getListaCpfGespes();
            List<ModelCpfGespesWs> mcg = list.stream().map(x -> new ModelCpfGespesWs(x)).collect(Collectors.toList());
            return mcg;
        } catch (Exception exception) {
            throw new WebApplicationException(Response.status(Response.Status.BAD_REQUEST).entity(exception.getMessage()).build());
        }
