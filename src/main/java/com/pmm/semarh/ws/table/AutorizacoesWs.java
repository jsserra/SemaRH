...
import com.pmm.semarh.dao.AutorizacoesDao;
...
public class AutorizacoesWs {

    @EJB
    AutorizacoesDao daoAutorizacoes;

    @GET
    @Path("getListaAutorizacoesWs")
    public List<Autorizacoes> getListaAutorizacoes(@Context HttpHeaders headers, @Context HttpServletRequest request) {
        ...
        try {
            ...
            return daoAutorizacoes.getListaAutorizacoes();
