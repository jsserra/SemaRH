...
import com.pmm.semarh.dao.TipoSanguineoDao;
 ...
 */
@Named
@Path("tiposanguineows")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class TipoSanguineoWs {

    @EJB
    TipoSanguineoDao daoTipoSanquineo;
   

    @GET
    @Path("getListaTipoSanguineo")
    public List<TipoSanguineo> getListaTipoSanguineo(@Context HttpHeaders headers, @Context HttpServletRequest request) {
       ...
       //     daoUserLog.criarLog("Lista de Sexos", "Listar", headers.getRequestHeader("chave").get(0), request.getPathInfo(), headers.getRequestHeader("appv").get(0),"SDGC", request.getRemoteAddr());
            return daoTipoSanquineo.getListaTipoSanguineo();
