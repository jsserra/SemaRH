...
import com.pmm.semarh.dao.TipoCNHDao;
...
public class TipoCNHWs {
    ...
    @GET
    @Path("getListaCNH")
    public List<TipoCNH> getListaTipoCNH(@Context HttpHeaders headers, @Context HttpServletRequest request) {
